...
import com.ali.core.coins.families.BitFamily;
import com.ali.core.coins.families.NxtFamily;
import com.ali.core.exceptions.UnsupportedCoinTypeException;
...
import com.ali.wallet.ui.dialogs.CreateNewAddressDialog;
import com.ali.wallet.ui.widget.AmountEditView;
import com.ali.wallet.util.QrUtils;
...
import static com.ali.wallet.ExchangeRatesProvider.getRate;
...
public class AddressRequestFragment extends WalletFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareaddress(addressLabelView.getText().toString());
    ...
    // Share image
    private void shareaddress(String adrr) {
        Intent sendIntent = new Intent();
        sendIntent.setAction(Intent.ACTION_SEND);
        sendIntent.putExtra(Intent.EXTRA_TEXT, adrr);
